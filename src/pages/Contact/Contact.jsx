    ...
    return (
      <section className='mt-10 lg:mt-20 p-0 lg:p-9'>
          <div className='flex flex-col gap-16'>
            ...
            {/** Отправить сообщение */}
            <div className='flex flex-col-reverse lg:flex-row gap-6 p-4 lg:p-0'>
              ...
              {/** Отправить сообщение */}
              <div className='flex flex-col bg-white p-8 gap-4 rounded-xl w-full lg:w-[60%]'>
                {/**Имя Фамилия */}
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <input type="text" placeholder="Placeholder" className='bg-[#F6F9FD] rounded-md py-3 px-6 pb-15'></input>
                </div>
                {/**Кнопка */}
                <div className='flex justify-center'>
                  <button className="hidden lg:inline-flex items-center justify-center gap-2 px-6 py-3 mt-5 text-white bg-[#4E87D0] rounded-lg font-medium text-base active:scale-95 transition transform duration-150 hover:bg-[#254194]">Отправить сообщение</button>
                </div>
