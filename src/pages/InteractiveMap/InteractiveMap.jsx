...
function InteractiveMap() {
    return (
      <section className='relative h-screen w-full overflow-hidden mt-18'>
        {/**Map*/}
        <img src={Map} alt='Interactive map' className='w-full lg:h-full object-cover z-0'/>
        {/**Map info */}
        <div className='absolute bg-white lg:left-8 lg:top-8 lg:bottom-8 z-10 p-3 w-full lg:w-[30%] rounded-lg shadow-xl flex flex-col gap-4 overflow-y-auto'>
